...
export default function CaseStudy({ project, onBack }) {
  const [activeTab, setActiveTab] = useState(project.defaultTab || "overview");
  ...
  return (
    <article className="case-study-page">
      ...
      {category === "Social Media Posts" ? (
        <section className="cs-content-section container" style={{ marginTop: "40px" }}>
                  ...
                  <div className="cs-tab-overview">
                    ...
                    <div className="cs-showcase-image-wrapper">
                      ...
                      {category === "Mobile apps" ? (
                        <div className="cs-mockup-device-mobile">
                          <div className="cs-mockup-phone-frame">
                            <div className="cs-mockup-screen">
                              <img src={project.image} alt={`${project.title} Interface`} className="cs-showcase-image" />
                            </div>
                            <div className="cs-mockup-island"></div>
                          </div>
                        </div>
                      ) : category === "Web applications" || category === "Website" ? (
                        <div className="cs-mockup-device-laptop">
                          <div className="cs-mockup-laptop-frame">
                            <div className="cs-mockup-browser-header">
                              <span className="cs-mockup-dot dot-red"></span>
                              <span className="cs-mockup-dot dot-yellow"></span>
                              <span className="cs-mockup-dot dot-green"></span>
                            </div>
                            <div className="cs-mockup-screen">
                              <img src={project.image} alt={`${project.title} Interface`} className="cs-showcase-image" />
                            </div>
                ...
                {activeTab === "gallery" && (
                  <div className="cs-tab-gallery">
                    ...
                    <p className="cs-paragraph" style={{ marginBottom: "32px" }}>
                      A collection of high-fidelity interface screenshots and design boards.
                    </p>

                    <div className={`cs-behance-flow ${category === "Mobile apps" ? "mobile-layout" : "web-layout"}`}>
                      {screenshots.map((shot, idx) => (
                        <div key={idx} className="cs-behance-item">
                          <img src={shot.url} alt={shot.caption || `Screenshot ${idx + 1}`} className="cs-behance-img" />
                          {shot.caption && (
                            <p className="cs-behance-caption dim">{shot.caption}</p>
                          )}
                        </div>
                      ))}
                    </div>
